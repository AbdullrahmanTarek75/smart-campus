...
class _EventsScreenState extends State<EventsScreen> with SingleTickerProviderStateMixin {
  ...
  bool _isAdmin(AuthController authController) {
    ...
    return user != null && (user.email == 'demo@example.com' || user.email.endsWith('@admin.com'));
  }
  ...
  Future<void> _deleteEvent(EventModel event) async {
    ...
    try {
      ...
      // Delete directly from Firestore since the controller method is removed
                      ...
                      Hero(
                        ...
                        child: CachedNetworkImage(
                          ...
                          placeholder: (context, url) => Container(
                            height: 180,
                            width: double.infinity,
                            color: isDarkMode ? AppTheme.mapsDarkSurface : Colors.grey[100],
                            child: const Center(
