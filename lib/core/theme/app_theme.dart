...
class AppTheme {
  // Updated Google Maps inspired colors
  static const Color darkNavy = Color(0xFF242F3E); // Google Maps dark mode background
  static const Color electricBlue = Color(0xFF4285F4); // Google Blue
  static const Color mapsGreen = Color(0xFF34A853); // Google Green
  static const Color mapsYellow = Color(0xFFFBBC05); // Google Yellow
  static const Color mapsRed = Color(0xFFEA4335); // Google Red
  ...
  // Light Theme - Google Maps inspired
  ...
  // Dark Theme - Google Maps inspired dark mode
