...
class FirebaseService {
    ...
    try {
      ...
      if (appCheck.app != null) {
        try {
          ...
          print('Firebase App Check initialized in FirebaseService');
          ...
          if (activationError.toString().contains('Too many attempts')) {
            ...
            print(
              'App Check rate limited in FirebaseService - will rely on main initialization',
            );
          } else {
            print(
              'App Check initialization error in FirebaseService: $activationError',
            );
          }
        }
      }
    } catch (e) {
      // Ignore errors, as App Check is initialized in main.dart
      print('App Check setup error in FirebaseService: $e');
    }
  }
  ...
  // MFA verification - simplified implementation
  Future<bool> isMfaVerified() async {
    debugPrint(
      '🔐 MFA verification check - simplified version that always returns true',
    );
